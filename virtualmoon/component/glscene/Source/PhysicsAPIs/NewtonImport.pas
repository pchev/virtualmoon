...
function NewtonCreateTreeCollisionFromMesh (const NewtonWorld : PNewtonWorld; const Mesh : PNewtonMesh; ShapeID : Int) : PNewtonCollision;       cdecl; external{$IFDEF __GPC__}name 'NewtonCreateTreeCollisionFromMesh'{$ELSE}NewtonDLL{$ENDIF __GPC__};
...
procedure NewtonBodyApplyImpulseArray (const Body : PNewtonBody; ImpuleCount : Int; StrideInByte : Int; const impulseArray : PFloat;
                                       const pointArray : PFloat);                                                                               cdecl; external{$IFDEF __GPC__}name 'NewtonBodyApplyImpulseArray'{$ELSE}NewtonDLL{$ENDIF __GPC__};
...
procedure NewtonMeshCalculateOOBB(const mesh : PNewtonMesh; const matrix : PFloat; x : PFloat; y : PFloat; z : PFloat);                          cdecl; external{$IFDEF __GPC__}name 'NewtonMeshCalculateOOBB'{$ELSE}NewtonDLL{$ENDIF __GPC__};

procedure NewtonMesApplyTransform (const Mesh : PNewtonMesh; const Matrix : PFloat);                                                             cdecl; external{$IFDEF __GPC__}name 'NewtonMesApplyTransform'{$ELSE}NewtonDLL{$ENDIF __GPC__};
...
procedure NewtonMeshPlaneClip (const Mesh : PNewtonMesh; const planeMatrix : PFloat; const PlaneTextureMatrix : PFloat; PlaneMaterial : Int;
