...
//      procedure DoProgress (Stage: TGLProgressStage; PercentDone: single; RedrawNow: Boolean; const Msg: string);
      ...
      function  NeedFaceGroup (m:TMeshObject;fgmode:TFaceGroupMeshMode;fgmat:STRING):TFGVertexIndexList;
      procedure NeedMeshAndFaceGroup (basemesh:TGLBaseMesh;layer:STRING;fgmode:TFaceGroupMeshMode;fgmat:STRING; var m:TMeshObject;var fg:TFGVertexIndexList);

      function  ReadLine:STRING;    // Read a single line of text from the source stream, set FEof to true when done.
...
const DXFcolorsRGB : ARRAY [1..255] OF LONGINT = (
  $FF0000,  $FFFF00,  $00FF00,  $00FFFF,  $0000FF,  $FF00FF,  $000000,  $000000,
  $000000,  $FF0000,  $FF8080,  $A60000,  $A65353,  $800000,  $804040,  $4D0000,
  $4D2626,  $260000,  $261313,  $FF4000,  $FF9F80,  $A62900,  $A66853,  $802000,
  $805040,  $4D1300,  $4D3026,  $260A00,  $261813,  $FF8000,  $FFBF80,  $A65300,
  $A67C53,  $804000,  $806040,  $4D2600,  $4D3926,  $261300,  $261D13,  $FFBF00,
  $FFDF80,  $A67C00,  $A69153,  $806000,  $807040,  $4D3900,  $4D4326,  $261D00,
  $262113,  $FFFF00,  $FFFF80,  $A6A600,  $A6A653,  $808000,  $808040,  $4D4D00,
  $4D4D26,  $262600,  $262613,  $BFFF00,  $DFFF80,  $7CA600,  $91A653,  $608000,
  $708040,  $394D00,  $434D26,  $1D2600,  $212613,  $80FF00,  $BFFF80,  $53A600,
  $7CA653,  $408000,  $608040,  $264D00,  $394D26,  $132600,  $1D2613,  $40FF00,
  $9FFF80,  $29A600,  $68A653,  $208000,  $508040,  $134D00,  $304D26,  $0A2600,
  $182613,  $00FF00,  $80FF80,  $00A600,  $53A653,  $008000,  $408040,  $004D00,
  $264D26,  $002600,  $132613,  $00FF40,  $80FF9F,  $00A629,  $53A668,  $008020,
  $408050,  $004D13,  $264D30,  $00260A,  $132618,  $00FF80,  $80FFBF,  $00A653,
  $53A67C,  $008040,  $408060,  $004D26,  $264D39,  $002613,  $13261D,  $00FFBF,
  $80FFDF,  $00A67C,  $53A691,  $008060,  $408070,  $004D39,  $264D43,  $00261D,
  $132621,  $00FFFF,  $80FFFF,  $00A6A6,  $53A6A6,  $008080,  $408080,  $004D4D,
  $264D4D,  $002626,  $132626,  $00BFFF,  $80DFFF,  $007CA6,  $5391A6,  $006080,
  $407080,  $00394D,  $26434D,  $001D26,  $132126,  $0080FF,  $80BFFF,  $0053A6,
  $537CA6,  $004080,  $406080,  $00264D,  $26394D,  $001326,  $131D26,  $0040FF,
  $809FFF,  $0029A6,  $5368A6,  $002080,  $405080,  $00134D,  $26304D,  $000A26,
  $131826,  $0000FF,  $8080FF,  $0000A6,  $5353A6,  $000080,  $404080,  $00004D,
  $26264D,  $000026,  $131326,  $4000FF,  $9F80FF,  $2900A6,  $6853A6,  $200080,
  $504080,  $13004D,  $30264D,  $0A0026,  $181326,  $8000FF,  $BF80FF,  $5300A6,
  $7C53A6,  $400080,  $604080,  $26004D,  $39264D,  $130026,  $1D1326,  $BF00FF,
  $DF80FF,  $7C00A6,  $9153A6,  $600080,  $704080,  $39004D,  $43264D,  $1D0026,
  $211326,  $FF00FF,  $FF80FF,  $A600A6,  $A653A6,  $800080,  $804080,  $4D004D,
  $4D264D,  $260026,  $261326,  $FF00BF,  $FF80DF,  $A6007C,  $A65391,  $800060,
  $804070,  $4D0039,  $4D2643,  $26001D,  $261321,  $FF0080,  $FF80BF,  $A60053,
  $A6537C,  $800040,  $804060,  $4D0026,  $4D2639,  $260013,  $26131D,  $FF0040,
  $FF809F,  $A60029,  $A65368,  $800020,  $804050,  $4D0013,  $4D2630,  $26000A,
  $261318,  $545454,  $767676,  $989898,  $BBBBBB,  $DDDDDD,  $FFFFFF );
...
begin
  result:= ((bgr SHR 16) and $FF) or (bgr AND $FF00) or ((bgr SHL 16) and $FF0000)
end;
            ...
            #10, #13 : begin
                         ...
                         if FBufPos>Length(FBuffer) then
                           if StreamEof(FSourceStream) then
                             ...
                             FillBuffer;
                         if ((FBuffer[FBufPos]=#10) or (FBuffer[FBufPos]=#13)) and (FBuffer[FBufPos]<>NewLineChar) then
                           Inc(FBufPos);
                         break;
                       end;
            else
...
begin
  if HasPushedCode then
    ...
    begin
      ...
      if result=-1 then
        raise Exception.create ('Invalid DXF Code '+s+' on Line #'+IntToStr(FLineNo));
    end;
end;
...
begin
  ...
  repeat
    ...
    case code of
      0 :;
      2 :layername:=ReadLine;
      70:ReadLine; // freeze and lock flags
      62:color :=ReadLine;
      else ReadLine;
    end;
  until code=0;
...
var code,idx,indexoffset:INTEGER;
    i,j,k:INTEGER;
    BlockName,s:STRING;
    pt,
    insertpoint,scale :TAffineVector;
    blockmesh   :TGLBaseMesh;
    blockproxy  :TGLProxyObject;
    mo_block    :TMeshObject;
    mo_base     :TMeshObject;
    fg_block,
    fg_base     :TFGVertexIndexList;
begin
  BlockName:='';
  ...
  repeat                // see ReadBlocks for details
    ...
    case code of
      0 :;
      2 : BlockName:=ReadLine;
      10: insertpoint[0] := ReadDouble;
      20: insertpoint[1] := ReadDouble;
      30: insertpoint[2] := ReadDouble;
      41: scale[0] := ReadDouble;
      42: scale[1] := ReadDouble;
      43: scale[2] := ReadDouble;
      else
        s:=ReadLine;
    end;
  until code=0;
        ...
        begin
          ...
          for j:=0 to mo_block.FaceGroups.Count-1 do
            begin
              ...
              fg_base :=NeedFaceGroup (mo_base,fg_block.mode,fg_block.MaterialName);
              for k:=0 to fg_block.VertexIndices.count-1 do
                begin
                  fg_base.VertexIndices.Add(fg_block.VertexIndices[k]+IndexOffset);
                end;
            end;
        end;
...
function  TGLDXFVectorFile.NeedMesh (basemesh:TGLBaseMesh;layer:STRING):TMeshObject;
var i:INTEGER;
begin
  i:=0;
  while (i<basemesh.MeshObjects.Count) and not (basemesh.MeshObjects[i].name =layer) do
    inc(i);
...
function  TGLDXFVectorFile.NeedFaceGroup (m:TMeshObject;fgmode:TFaceGroupMeshMode;fgmat:STRING):TFGVertexIndexList;
var i:INTEGER;
    acadcolor:LONGINT;
...
begin
  i:=0;
  while (i<m.FaceGroups.Count) and not ((m.FaceGroups[i] is TFGVertexIndexList) and ((m.FaceGroups[i] as TFGVertexIndexList).mode=fgmode) and (m.FaceGroups[i].MaterialName =fgmat)) do
    inc(i);
            ...
            begin
              ...
              if acadcolor in [1..255] then
                begin
                  ...
                  libmat.Name :=fgmat;
                  libmat.Material.FrontProperties.Diffuse.AsWinColor :=rgb2bgr(dxfcolorsrgb[acadcolor]);
                  libmat.Material.BackProperties.Diffuse.AsWinColor  :=rgb2bgr(dxfcolorsrgb[acadcolor]);
...
procedure TGLDXFVectorFile.NeedMeshAndFaceGroup (basemesh:TGLBaseMesh;layer:STRING;fgmode:TFaceGroupMeshMode;fgmat:STRING; var m:TMeshObject;var fg:TFGVertexIndexList);
begin
...
begin
  ...
  repeat
    ...
    case code of
      0:;
      8:  layer:=ReadLine; // Layer
      10: pts[0][0] := ReadDouble;
      11: pts[1][0] := ReadDouble;
      12: pts[2][0] := ReadDouble;
      13: begin pts[3][0] := ReadDouble; isquad:=TRUE end;
      20: pts[0][1] := ReadDouble;
      21: pts[1][1] := ReadDouble;
      22: pts[2][1] := ReadDouble;
      23: begin pts[3][1] := ReadDouble; isquad:=TRUE end;
      30: pts[0][2] := ReadDouble;
      31: pts[1][2] := ReadDouble;
      32: pts[2][2] := ReadDouble;
      33: begin pts[3][2] := ReadDouble; isquad:=TRUE end;
      62: Color:=ReadLine; // Color
      else ReadLine;
    end;
  until code=0;
  PushCode(0);
  isquad:=isquad and ((pts[2][0]<>pts[3][0]) or (pts[2][1]<>pts[3][1]) or (pts[2][2]<>pts[3][2]));
  if isquad then
...
procedure TGLDXFVectorFile.ReadEntityPolyLine(basemesh:TGLBaseMesh);
  ...
  begin
    ...
    repeat
      ...
      case code of
        0  :;
        5  : ReadLine; // ID   :=ReadHex16;
        8  : ReadLine; // ignore per vertex layer. Polyline vertices cannot cross layers!
        10 : pt[0]:=ReadDouble;
        20 : pt[1]:=ReadDouble;
        30 : pt[2]:=ReadDouble;
        62 : Color:=ReadLine;
        70 : i70 := ReadInt;
        71 : i71 := abs(ReadInt); // negative values should hide points... we cannot
        72 : i72 := abs(ReadInt);
        73 : i73 := abs(ReadInt);
        74 : i74 := abs(ReadInt);
        100: ReadLine; // Subclass Marker
        330: ReadLine; // Soft Pointer?
        else ReadLine;
      end;
    until code=0;
    PushCode(0);
...
//    DoProgress (psRunning,FSourceStream.Position/FSourceStream.Size*100,false,'');
    case code of
      0: begin
           s:=ReadLine;
           if      s='POLYLINE' then ReadEntityPolyLine (basemesh)
           else if s='3DFACE'   then ReadEntity3Dface   (basemesh)
           else if s='INSERT'   then ReadInsert         (basemesh)
           else if s='ENDSEC'   then begin end
           else if s='ENDBLK'   then begin end
           else
             asm nop end    (* put breakpoint here to catch other entities *)
         end;
      else
         s:=ReadLine;
    end;
            ...
            fgmmTriangles: begin
                             for j:=0 to (VertexIndices.count div 3)-1 do
                               begin
                                 ...
                                 m.Normals.items[ VertexIndices[j*3  ] ]:=VectorAdd (m.Normals.items[VertexIndices[j*3  ]],n);
                                 m.Normals.items[ VertexIndices[j*3+1] ]:=VectorAdd (m.Normals.items[VertexIndices[j*3+1]],n);
                                 m.Normals.items[ VertexIndices[j*3+2] ]:=VectorAdd (m.Normals.items[VertexIndices[j*3+2]],n);
                               end;
                           end;
            fgmmQuads    : begin
                             for j:=0 to (VertexIndices.count div 4)-1 do
                               begin
                                 ...
                                 n:=CalcPlaneNormal(v1,v2,v3);
                                 m.Normals.items[ VertexIndices[j*4  ] ]:=VectorAdd (m.Normals.items[VertexIndices[j*4  ]],n);
                                 m.Normals.items[ VertexIndices[j*4+1] ]:=VectorAdd (m.Normals.items[VertexIndices[j*4+1]],n);
                                 m.Normals.items[ VertexIndices[j*4+2] ]:=VectorAdd (m.Normals.items[VertexIndices[j*4+2]],n);
                                 m.Normals.items[ VertexIndices[j*4+3] ]:=VectorAdd (m.Normals.items[VertexIndices[j*4+3]],n);
                               end;
                           end;
          end;
        ...
        begin
          ...
          if s='EOF' then
            ...
            begin
              code:=GetCode;
              if code<>2 then
                raise Exception.create ('Name must follow Section'+' on Line #'+IntToStr(FLineNo))
              else
                begin
                  s:=ReadLine;
                  if      s='HEADER'   then SkipSection
                  else if s='BLOCKS'   then ReadBlocks
                  else if s='ENTITIES' then ReadEntities (owner)
                  else if s='CLASSES'  then SkipSection
                  else if s='TABLES'   then ReadTables
                  else if s='OBJECTS'  then SkipSection
                  else
                    SkipSection;
                end
            end
          else if s='ENDSEC' then
            raise Exception.create ('SECTION/ENDSEC Mismatch'+' on Line #'+IntToStr(FLineNo))
        end
      else
...
initialization
  RegisterVectorFileFormat('dxf','Drawing Exchange Format'    ,TGLDXFVectorFile);
end.
