...
rstconv -i units/x86_64-linux-gtk2/u_translation.rsj -o language/datlun.po
rstconv -i units/x86_64-linux-gtk2/u_translation_database.rsj -o language/vmadatabase.po
