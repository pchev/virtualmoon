...
begin
  ...
  if assigned(PlugInManagerPropForm) then
    PlugInManagerPropForm.Free;
...
begin
  ...
  begin
    ...
    DescriptionMemo.Lines.Text := string(FManager.PlugIns[Entry].GetDescription);
...
begin
  PlugInManagerPropForm.NameBox.Items.Add(string(StrPas(Name)));
end;
