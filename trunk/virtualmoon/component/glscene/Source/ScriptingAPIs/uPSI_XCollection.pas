...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TXCollection') do
  begin
...
begin
  ...
  with CL.AddClassN(CL.FindClass('TPersistent'),'TXCollectionItem') do
  begin
...
procedure RIRegister_TXCollectionItem(CL: TPSRuntimeClassImporter);
begin
  with CL.Add(TXCollectionItem) do
  begin
    RegisterVirtualConstructor(@TXCollectionItem.Create, 'Create');
