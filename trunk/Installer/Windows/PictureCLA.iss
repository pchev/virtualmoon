...
OutputDir=setup
OutputBaseFilename=picture_cla
Compression=zip
...
[CustomMessages]
eng.MyAppName=CLA pictures
fre.MyAppName=images CLA

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureCLA\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
