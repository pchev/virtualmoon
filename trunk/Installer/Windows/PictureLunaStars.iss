...
OutputDir=setup
OutputBaseFilename=picture_lunastars
Compression=zip
...
[CustomMessages]
eng.MyAppName=LunaStars pictures
fre.MyAppName=images LunaStars

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureLunaStars\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
