...
i=1; while ((i<41)); 
do ((j=80*(i-1))); 
 echo convert l5r$i.tif +repage +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% -scene $j  L5/%d.jpg;
 convert l5r$i.tif +repage +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% -scene $j  L5/%d.jpg;
 ((i++));  
done;
convert l5r1.tif -resize 3000x1000\!  RS0.jpg
convert l5r40.tif -resize 3000x1000\!  RS1.jpg
