...
echo make L3 slice 
mkdir L3
convert l3.tif +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% L3/%d.jpg
convert l3.tif +gravity -crop 20000x1000 R%d.png
...
echo make L2 slice
convert l3.tif -resize 10000x5000 l2.tif
mkdir L2
...
echo make L1 slice 
convert l3.tif -resize 4000x2000 l1.tif
mkdir L1
