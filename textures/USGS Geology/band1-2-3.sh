...
echo make L3 slice 
mkdir L3
convert Lola-Kaguya-Geologic-l3.tif +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% L3/%d.jpg
convert Lola-Kaguya-Geologic-l3.tif +gravity -crop 20000x1000 R%d.png
...
echo make L2 slice
convert Lola-Kaguya-Geologic-l3.tif -resize 10000x5000 l2.tif
mkdir L2
