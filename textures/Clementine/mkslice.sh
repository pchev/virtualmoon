...
echo L1
mkdir L1
#convert clemL3.jpg -resize 4000x2000 l1.jpg
convert clemL1.jpg +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% L1/%d.jpg

echo L2
mkdir L2
#convert clemL3.jpg -resize 10000x5000 l2.jpg
convert clemL2.jpg +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% L2/%d.jpg
convert clemL2.jpg +gravity -crop 10000x1000 R%d.png
...
echo L3
mkdir L3
#convert clem.jpg -resize 20000x10000 l3.jpg
convert clemL3.jpg +gravity -crop 1000x1000 -bordercolor white -border 12x12 -quality 65% L3/%d.jpg
convert clemL3.jpg +gravity -crop 20000x1000 R%d.png
convert R0.png -resize 3000x1000\!  RS0.jpg
...
mkdir L4
# 40000x20000
convert clemL4.jpg -crop 40000x1000 L4R%d.png
