...
OutputDir=.\
OutputBaseFilename=virtualmoon-veryhires-lolakaguya
Compression=zip
...
[CustomMessages]
eng.MyAppName=VMA Very high resolution LOLA-Kaguya Shade textures
fre.MyAppName=AVL Textures LOLA-Kaguya Shade très hautes résolutions

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: vmapro\Data4-4\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
