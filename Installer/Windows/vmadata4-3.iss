...
OutputDir=.\
OutputBaseFilename=virtualmoon-veryhires-lrowac
Compression=zip
...
[CustomMessages]
eng.MyAppName=VMA Very high resolution LRO WAC textures
fre.MyAppName=AVL Textures LRO WAC très hautes résolutions
