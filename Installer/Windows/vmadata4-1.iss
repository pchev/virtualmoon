...
OutputDir=.\
OutputBaseFilename=virtualmoon-veryhires-change
Compression=zip
...
[CustomMessages]
eng.MyAppName=VMA Very high resolution Chang'e textures
fre.MyAppName=AVL Textures  Chang'e très hautes résolutions

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: vmapro\Data4-1\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
