...
OutputDir=setup
OutputBaseFilename=picture_bestofpicdumidi
Compression=zip
...
[CustomMessages]
eng.MyAppName=Best of Pic du Midi pictures
fre.MyAppName=images Best of Pic du Midi

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureBestOfPicduMidi\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
