...
OutputDir=.\
OutputBaseFilename=virtualmoon-hires-LAC
Compression=zip
...
[CustomMessages]
eng.MyAppName=VMA High resolution LAC textures
fre.MyAppName=AVL Textures hautes résolutions LAC

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: vmapro\Data5\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs
