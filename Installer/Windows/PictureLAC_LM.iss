...
OutputDir=setup
OutputBaseFilename=picture_lac_lm
Compression=zip
...
[CustomMessages]
eng.MyAppName=LAC-LM pictures
fre.MyAppName=images LAC_LM

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureLAC_LM\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
