...
# script to build the Moon kernel for VMA
# detail of the merge operation is in file merge_vma.txt
...
wget ftp://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_720101_070426.bpc
wget ftp://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/earth_latest_high_prec.bpc
wget ftp://naif.jpl.nasa.gov/pub/naif/generic_kernels/pck/moon_pa_de421_1900-2050.bpc
wget ftp://naif.jpl.nasa.gov/pub/naif/generic_kernels/fk/satellites/moon_080317.tf
