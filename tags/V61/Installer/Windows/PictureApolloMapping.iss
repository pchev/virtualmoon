...
OutputDir=setup
OutputBaseFilename=picture_apollomapping
Compression=zip
...
[CustomMessages]
eng.MyAppName=ApolloMapping pictures 
fre.MyAppName=images ApolloMapping

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureApolloMapping\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
