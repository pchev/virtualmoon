...
OutputDir=setup
OutputBaseFilename=picture_bestofdamianpeach
Compression=zip
...
[CustomMessages]
eng.MyAppName=Best of Damian Peach pictures
fre.MyAppName=images Best of Damian Peach

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureBest_Damian_Peach\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
