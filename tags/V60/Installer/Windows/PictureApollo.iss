...
OutputDir=setup
OutputBaseFilename=picture_apollo
Compression=zip
...
[CustomMessages]
eng.MyAppName=Apollo pictures
fre.MyAppName=images Apollo

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureApollo\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
