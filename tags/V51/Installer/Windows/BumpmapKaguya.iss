...
OutputDir=setup
OutputBaseFilename=bumpmap_kaguya
Compression=zip
...
[CustomMessages]
eng.MyAppName=Kaguya bumpmap
fre.MyAppName=bumpmap Kaguya

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: BumpmapKaguya\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
