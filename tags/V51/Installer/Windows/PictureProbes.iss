...
OutputDir=setup
OutputBaseFilename=picture_probes
Compression=zip
...
[CustomMessages]
eng.MyAppName=Probes pictures
fre.MyAppName=images Sondes

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureProbes\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
