...
OutputDir=setup
OutputBaseFilename=picture_bestofamateurs
Compression=zip
...
[CustomMessages]
eng.MyAppName=Best of Amateurs pictures
fre.MyAppName=images Best of Amateurs

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureBestOfAmateurs\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
