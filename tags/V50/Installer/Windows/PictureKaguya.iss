...
OutputDir=setup
OutputBaseFilename=picture_kaguya
Compression=zip
...
[CustomMessages]
eng.MyAppName=Kaguya pictures
fre.MyAppName=images Kaguya

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureKaguya\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
