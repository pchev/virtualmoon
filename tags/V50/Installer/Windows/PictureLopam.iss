...
OutputDir=setup
OutputBaseFilename=picture_lopam
Compression=zip
...
[CustomMessages]
eng.MyAppName=Lopam pictures
fre.MyAppName=images Lopam

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureLopam\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
