...
[CustomMessages]
MyAppName=Virtual Moon Atlas, Greek translation

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: translation\el\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
