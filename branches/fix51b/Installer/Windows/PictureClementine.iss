...
OutputDir=setup
OutputBaseFilename=picture_clementine
Compression=zip
...
[CustomMessages]
eng.MyAppName=Clementine pictures
fre.MyAppName=images Clementine 

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: PictureClementine\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
