...
OutputDir=setup
OutputBaseFilename=texture_lopam
Compression=zip
...
[CustomMessages]
eng.MyAppName=Lopam texture
fre.MyAppName=texture Lopam

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: TexturesLopam\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
