...
[CustomMessages]
MyAppName=Virtual Moon Atlas, Czech translation

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: translation\cs\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
