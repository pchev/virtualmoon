...
OutputDir=setup
OutputBaseFilename=texture_airbrush_no_albedo
Compression=zip
...
[CustomMessages]
eng.MyAppName=Airbrush no albedo texture
fre.MyAppName=texture Airbrush sans albedo

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: TexturesAirbrush_na\Data\*; DestDir: {app}; Flags: recursesubdirs ignoreversion replacesameversion createallsubdirs 
